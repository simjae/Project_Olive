					...
					<div class="row">
						<div class="col-xl-12 col-lg-12">
							...
							<div class="row justify-content-center">
								<h2 class="">
									계정 등록 &nbsp;&nbsp; <i class="fas fa-user-circle"></i>
								</h2>
							</div>
							<div id="employNewEmpModal">
								<form action="/HR_management/EmployeeAccount.do" method="POST" id="newEmpForm">
									<div class="row justify-content-center">
										<div class="col-md-12">
											<div class="pt-3 pr-3 pl-3">
												...
												<div class="row p-3">
													<div class="input-group col-md-12">
														<div class="input-group-prepend">
															<span class="input-group-text each-label" id="checkEmpNo">이
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 름</span>
														</div>
														<input type="text" class="form-control"
