...
<body id="page-top">
							...
							<tbody>
								<tr>
									...
									<th><input type="text" value="급여이력번호" hidden>
										<button class="table-button" id="salary1">보기</button></th>
								</tr>
								<tr>
									<td>Melissa</td>
									<td>5150</td>
									...
									<td>6000</td>
									<td>6000</td>
									<th><button class="table-button" id="salary2">보기</button></th>
								</tr>
								<tr>
									<td>Dom</td>
									<td>6000</td>
	...
	<script>
		$("#salary2").click(function(){
			...
			window.open("${pageContext.request.contextPath}/HRinfo/SalaryDetail.do","_blank","top="+top+", left="+left+", height="+windowH+", width="+windowW+"resizable=no");
